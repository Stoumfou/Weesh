...
exports.sites = {
	...
	cdiscount: function(path) {

		var productSelector = this.base();

		productSelector.id = 'form[name="TechnicalForm"] #TechFormProductId@value'; 
		productSelector.title = 'meta[property="og:title"]@content';
		productSelector.original_price = '#fpBlockPrice .fpStriked';
		productSelector.price = '#fpBlockPrice .fpPrice.price@content';
		productSelector.brand = '.fpBrand .dn[itemprop="brand"]';
		productSelector.details = x(['fpDescTb fpDescTbPub > tr > td']);
