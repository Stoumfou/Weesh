...
exports.sites = {
	...
	darty: function (path) {
		...
		productSelector.id = 'darty_product_main_content product_column product_left@data-codic';// ID NE MARCHE PAS
		productSelector.title = 'meta[property="og:title"]@content';
		...
		productSelector.description = 'meta[property="og:description"]@content';
		productSelector.image = xDelay('meta[property="og:image"]@content'); // Prend la petite image
		// Grande :  http://image.darty.com/petit_electromenager/aspirateur-balai_main/aspirateur_balai/bosch_bbh21633_readyy_y_l1609144255011A_154116859.jpg
		// Petite :  http://image.darty.com/petit_electromenager/aspirateur-balai_main/aspirateur_balai/bosch_bbh21633_readyy_y_f1609144255011A_154116859.jpg
